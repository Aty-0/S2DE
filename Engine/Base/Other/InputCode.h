...
{
    enum S2DE_API MouseKeyCode
    {        
        KEY_BUTTON_LEFT    = SDL_BUTTON_LEFT,
        KEY_BUTTON_MIDDLE  = SDL_BUTTON_MIDDLE,
        KEY_BUTTON_RIGHT   = SDL_BUTTON_RIGHT,
        KEY_BUTTON_X1      = SDL_BUTTON_X1,
        KEY_BUTTON_X2      = SDL_BUTTON_X2
    };

	//Key Codes from SDL 2 
    //FIX ME: Rename to KeyboardKeyCode
	enum S2DE_API KeyCode
	{
		...
		KEY_EXECUTE_SDL = SDL_SCANCODE_EXECUTE,
    ...
    static const std::uint16_t KeyboardSize = 282;
    static const std::uint16_t MouseSize    = 5;
}